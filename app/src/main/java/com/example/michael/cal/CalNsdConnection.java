...
public class CalNsdConnection {
    ...
    public CalNsdConnection(Handler handler) {
        mUpdateHandler = handler;
        mProjectServer = new ChatServer(handler);
    }
    ...
    public void connectToServer(InetAddress address, int port) {
        mProjectClient = new ChatClient(address, port);
    }

    public void sendMessage(String msg) {
        if (mProjectClient != null) {
            mProjectClient.sendMessage(msg);
        }
    }
